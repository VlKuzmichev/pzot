...
INSERT INTO questions (name, answered, right_answers, question_group_id) VALUES
  ('При какой численности работников в организации должна обязательно создаваться служба охраны труда?', false, 1, 100007), -- 100009
  ('Какие меры по оказанию первой помощи пострадавшему необходимо предпринять при обморожении?', false, 1, 100007); -- 100010

INSERT INTO answers (name, checked, truth, question_id) VALUES
('Более 50 человек', false, true, 100009), -- 100011
('Более 30 человек', false, false, 100009), -- 100012
('Более 15 человек', false, false, 100009), -- 100013
('Более 20 человек', false, false, 100009), -- 100014
('Прекратить воздействие низких температур, восстановить кровообращение, наложив теплоизолирующие повязки, дать обезболивающее' ||
 ' и любое теплое питье, доставить в лечебное учреждение', false, true, 100010), -- 100015
('Прекратить воздействие низких температур, быстро растереть отмороженные участки, наложить сухую стерильную повязку, ' ||
 'дать обильное питье и обезболивающее', false, false, 100010), -- 100016
